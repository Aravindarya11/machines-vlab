    ...
    const knowledgeBase = [
        {
            ...
            answer: "Hi there! 👋 Welcome to the Virtual Lab. I am your EMVL Assistant. You can ask me questions about **EMF**, **MMF**, or **ZPF** methods, or ask **how to use** the simulation deck!"
        },
        {
    ...
    function toggleChat() {
        ...
        if (!windowEl.classList.contains('hidden')) {
            ...
            if (messagesEl.children.length === 0) {
                showBotResponse("Hi! I am the EMVL Virtual Assistant. ⚡ Ask me anything about Synchronous Machine Regulation (EMF, MMF, or ZPF methods), or how to use the simulator!");
            }
        }
    }
